...
<!-- Section description -->
<p class="text-center w-responsive mx-auto mb-5">Want to tell something? or want to know something? If you have any, you are always welcome to send us email of your suggestions or queries.</p>
        ...
        <div class="col-lg-4">
            ...
            <div class="card-body contact text-center h-100 white-text">
                ...
                <ul class="text-lg-left list-unstyled ml-4">
                    ...
                    <li>
                        <p><i class="fas fa-phone pr-2"></i><a class="text-white" href="tel:+8801735737037">+ 88 01X XXXX XXXX</a></p>
                    </li>
                    <li>
                        <p><i class="fas fa-envelope pr-2"></i><a class="text-white" href="mailto:me@rasedulsaju.com">contact@example.com</a></p>
                    </li>
                </ul>
                <hr class="hr-light my-4">
                <ul class="list-inline text-center list-unstyled">
                    <li class="list-inline-item">
                        <a href="https://twitter.com" target="_blank" class="p2 fa-lg tw-ic">
                            <i class="fab fa-twitter"></i>
                        </a>
                    </li>
                    <li class="list-inline-item">
                        <a href="https://www.linkedin.com" target="_blank" class="p2 fa-lg li-ic">
                            <i class="fab fa-linkedin-in"> </i>
                        </a>
                    </li>
                    <li class="list-inline-item">
                        <a href="https://www.instagram.com" target="_blank" class="p2 fa-lg ins-ic">
